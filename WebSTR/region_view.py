...
def get_species(DbSTRPath):
    ct = connect_db(DbSTRPath).cursor()
    species = ct.execute("select genome_build_id, genome_build_str from GENOMES").fetchall()
    return species
...
def GetColor(period):
    colors = ["gray","red","gold","blue","purple","green","green","green","green","green","green","green","Green","green","green","green","green","green","green","green","green"]
